abstract class Shape {
    ...
    public Shape(String name) {
        this.name = name;
        System.out.print("Object " + name + " has been created! (Shape constructor)\n");
    }
...
class Rectangle extends Shape {
    ...
    public Rectangle(String name, double width, double height) {
        ...
        this.width = width;
        this.height = height;
        System.out.print("Object " + name + " has been created! (Rectangle constructor)\n");
    }
...
class Square extends Rectangle {
    public Square(String name, double width) {
        ...
        System.out.print("Object " + name + " has been created! (Square constructor)\n");
    }
}
